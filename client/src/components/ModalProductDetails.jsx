  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          onClick={onClose}
          className="fixed bottom-8 right-8 z-50 bg-red-600 text-white hover:bg-red-700 px-8 py-3 rounded-xl shadow-lg text-lg font-semibold transition-colors"
        >
          Отказ
        </button>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="flex flex-col md:flex-row gap-16 max-w-[1600px] w-full mx-auto min-h-[800px]">
              ...
              {/* Дясна колона – заглавие/цена/бутон (примерно, ако имате тези компоненти) */}
